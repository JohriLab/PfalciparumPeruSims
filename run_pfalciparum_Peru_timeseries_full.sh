...
# Replicate ID (defaults to 1 if run outside of SLURM array) 
repID=${SLURM_ARRAY_TASK_ID:-1}

# Simulation parameters -- EDIT THESE TO CHANGE SELECTION COEFFICIENT
SEL1="0.07"   # hrp2 selection coefficient
SEL2="0.07"   # hrp3 selection coefficient
SLIM_SCRIPT="pfalciparum_Peru_timeseries_full.slim"

# Directory structure 
BASE_DIR="/proj/johrilab/projects/PfalPeruSims/haploid/simulations_full"
