...
# Simulation parameters -- EDIT THESE TO RUN UNDER DIFFERENT SELECTION SCENARIOS
SEL1="0.07"   # hrp2 selection coefficient 
SEL2="0.07"   # hrp3 selection coefficient
SLIM_SCRIPT="pfalciparum_Peru_timeseries_Maynas.slim"

# Directory structure 
BASE_DIR="/proj/johrilab/projects/PfalPeruSims/haploid/simulations_Maynas"
